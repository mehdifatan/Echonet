...
def run(num_epochs=150,
    ...
    model=smp.Unet('resnet18', classes=4, encoder_weights='imagenet',activation='softmax')
    # model=smp.Unet('resnet18', classes=4, encoder_weights='imagenet',activation='softmax');
    ...
    # Set up optimizer
    #optim = torch.optim.SGD(model.parameters(), lr=1e-3, momentum=0.9,weight_decay=0.01)
    optim = torch.optim.Adam(model.parameters(), lr=0.001)
    #optim = torch.optim.Adadelta(model.parameters(), lr=0.001, weight_decay=0.0001)
